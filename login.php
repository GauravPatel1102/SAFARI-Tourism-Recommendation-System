<?php
// Include the db.php file that contains your database connection code
include 'db.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["login"])) {
    ...
    $sql = "SELECT * FROM travel WHERE (username='$username_or_email' OR email='$username_or_email')";
...
<div class="box-form">
    ...
    <div class="right">
        ...
        <div class="inputs">
            <input type="text" name="login-username-email" placeholder="Username or Email"> <!-- Change the name attribute to match your second code -->
            <br>
            <input type="password" name="login-password" placeholder="Password"> <!-- Change the name attribute to match your second code -->
        </div>
